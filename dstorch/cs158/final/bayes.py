...
def bayesClassify(features, vecRep, training, toClassify, outfile) :
	...
	classifiedDocs = classifyDocs(bigDict, priorDict, condProbDict, toClassify)
...
if __name__ == "__main__" :
	...
	vecRep = open(sys.argv[2])
	training = open(sys.argv[3])
	toClassify = open(sys.argv[4])
	outfile = open(sys.argv[5], "w")
	
	bayesClassify(features, vecRep, training, toClassify, outfile)
